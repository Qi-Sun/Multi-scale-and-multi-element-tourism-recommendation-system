...
def train_stage(network_framework: Dict):
    ...
    optimizer = optim.Adam(lstmLM.parameters(), lr=network_framework["learning_rate"], weight_decay=network_framework["weight_decay"])
            ...
            for hid in [8, 16, 24]:
                for bs in [32, 64]:
                    for wd in [0,1e-8]:
                        ...
                        framework["report_epochs"] = list(range(5,100,5)) + list(range(100,200,10)) + [200,
                                                      250, 300, 350]

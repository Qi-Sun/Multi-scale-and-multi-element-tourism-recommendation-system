...
class Corpus(object):
    ...
    def read_corpus_from_list(self, sentences_list):
        ...
        # get unique words
        for feature, sentence in sentences_list:
...
class LSModel_base(torch.nn.Module):
    ...
    def __init__(self, corpus: Corpus, network_framework: Dict):
        ...
        # 保存
        self.save_path = network_framework["save_path"]
...
def train_stage(network_framework: Dict):
    ...
    # 构建网络
    lstmLM = LSModel_base(corpus=corpus, network_framework=network_framework)
...
if __name__ == "__main__":
    Network_Framework = {"num_epochs": 400,
                         ...
                         "save_root_path": "ms_lstm_base_model_0418a",
                         "report_epochs": []}

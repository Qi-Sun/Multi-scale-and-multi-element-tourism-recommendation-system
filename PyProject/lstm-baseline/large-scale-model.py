...
if __name__ == "__main__":
    ...
    for lr in [1e-4, 5e-5, 2e-5]:
        for embed in [8, 16, 24, 32]:
            for hid in [8, 16, 24, 32]:
                for bs in [64, 32]:
                    model_path_id += 1
                    ...
                    framework["report_epochs"] = [5, 10, 15, 25, 30, 35, 40, 50, 60, 70, 80, 90, 100, 125, 150, 200,
                                                  250]
                    framework["save_path"] = "./ls_grid_search_model_0416a/model_%s" % model_path_id
    ...
    pickle.dump(res_list, open("./ls_grid_search_model_0416a/grid_search_model_res.pkl", 'wb'))
    json.dump(res_list, open("./ls_grid_search_model_0416a/grid_search_model_res.json", 'w'))

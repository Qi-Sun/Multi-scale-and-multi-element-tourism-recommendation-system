...
if __name__ == "__main__":
    test_model = './place_lstm_dense_model_nobos_0421a/model_20/place_scale_model_lstm_1_bs_32_lr_2_embed_16_hidden_4_epoch_1500.mdl'
    framework = {'num_epochs': 1500, 'num_lstm_layers': 1, 'batch_size': 32, 'embed_size': 16, 'hidden_size': 4,
                 'learning_rate': 2e-05, 'report_frequency': 9999, 'best_model_count': 3, 'create_corpus': True,
                 'weight_decay': 0, 'feature_size': 4,
                 'corpus_path': './place_lstm_dense_model_nobos_0421a/model_20/corpus.pkl',
                 'test_data_path': '../data/mms_test_feature_trips_pair.json',
                 'train_data_path': '../data/mms_train_feature_trips.json',
                 'save_path': './place_lstm_dense_model_nobos_0421a/model_20',
                 'save_root_path': 'place_lstm_dense_model_nobos_0421a',
    ...
    # json.dump(show_res)
    with open("./place_lstm_dense_model_nobos_0421a/place_show_res.txt", 'w') as wf:

...
if __name__ == "__main__":
    test_model = './ls_lstm_dense_model_nobos_0420a/model_9/ms_model_lstm_1_bs_64_lr_2_embed_24_hidden_24_epoch_1499.mdl'
    framework = {'num_epochs': 1500, 'num_lstm_layers': 1, 'batch_size': 64, 'embed_size': 24, 'hidden_size': 24,
                 'learning_rate': 2e-05, 'report_frequency': 9999, 'best_model_count': 3, 'create_corpus': True,
                 'weight_decay': 0, 'feature_size': 4,
                 'corpus_path': './ls_lstm_dense_model_nobos_0420a/model_9/corpus.pkl',
                 'test_data_path': '../data/ls_test_feature_trips_pair.json',
                 'train_data_path': '../data/ls_train_feature_trips.json',
                 'save_path': './ls_lstm_dense_model_nobos_0420a/model_9',
                 'save_root_path': 'ls_lstm_dense_model_nobos_0420a',
    ...
    # json.dump(show_res)
    with open("./ls_lstm_dense_model_nobos_0420a/show_res.txt",'w') as wf:
